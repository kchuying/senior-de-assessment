...
from datacleaner4 import generate_member_details
import pendulum
...
#dag=dag parameter will assign operator to DAG
    ...
    #Generate customer and member files for sql loading
    t6 = PythonOperator(task_id='generate_sql_files', python_callable=generate_member_details)

    #Send email to user, can add cc and bcc parameters
    t7 = EmailOperator(task_id='send_email_result',
